...
function loadSplom() {
  ...
  if (viewOptions.ligandcutoff) {
		...
		pathname = "../structures_database-ligand-cutoff/";
	 	...
	 	d3.json(pathname + "/" +pdb_name+"/"+ pdb_name + "_"+chains[0]+"stats.json", function(json_data) {
...
function loadUploadSplom() {
	 	...
	 	d3.json(pathname + "/" +pdb_name+"/"+ pdb_name + "_"+viewOptions.mychain+"stats.json", function(json_data) {
...
function loadSplomafterchainsselected() {
  ...
  updateURL(viewOptions);
	...
	if( viewOptions.chains[0] == viewOptions.chains[1] ){
	 	...
	 	d3.json(pathname + "/" +pdb_name+"/"+ pdb_name + "_"+viewOptions.chains[0]+"stats.json", function(json_data) {
...
function combineStats(){
  ...
  $.ajax({
	...
	$.ajax({
	  dataType: "json",
	  url: pathname + "/" +pdb_name+"/"+ pdb_name + "_"+viewOptions.chains[0]+"stats.json",
	  async: false,
	  success: function(data){
	...
	$.ajax({
	  dataType: "json",
	  url: pathname + "/" +pdb_name+"/"+ pdb_name + "_"+viewOptions.chains[1]+"stats.json",
	  async: false,
	  success: function(data){
