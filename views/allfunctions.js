...
// to keep the original values from the json files before removing HOH
var originaljsonnodes = new Array();
var originaljsonlinks = new Array();
...
function removeHOH() {
		...
		originaljsonnodes = json.nodes;
		originaljsonlinks = json.links;

		console.log("in removehoh")
...
function addHOH() {
		...
		json.nodes = originaljsonnodes;
		json.links = originaljsonlinks;

		console.log("in addhoh")
		reassignIndexesAfterHOHchange();

}

// if two chains are selected
...
function switchViewHOH(newView) {

  	if (newView === 'show') {
			addHOH();
			console.log("in switchViewHOH add")
    }

  	else if (newView === 'hide') {
			removeHOH();
			console.log("in switchViewHOH remove")
		}
    ...
    reDrawProtein([], []);
		...
		// CHECK THIS, DO WE NEED TO PUT IF ELSE FOR CHAIN SELECTION (LOADAFTERCHAIN SELECTED FUNCTION)
		loadSplom();
